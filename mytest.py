...
variableForAnInput = int(input("Enter A Value To Be Put In the Variable: "))
...
#print(variableForAString + " "  + str(variableForAFloat))
#print(f"type some text: {variableForAString} {variableForAFloat}")

print(variableForAString + " " +  variableForAnInput)